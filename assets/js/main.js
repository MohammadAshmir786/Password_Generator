...
const resultEl = document.querySelector(".result_viewbox");
...
// if this variable is true only then the copyBtn will appear, i.e. when the user first click generate the copyBtn will interact.
...
// Copy Password in clipboard in large size
...
// Copy Password in clipboard in mobile size
